...
namespace AtlasERP.Models
{
    ...
    public partial class atlasErpContextProcedures : IatlasErpContextProcedures
    {
        ...
        public virtual async Task<int> cierrePuntoVentaAsync(int? ID, int? ccia, string observacion, DateTime? fecierre, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[cierrePuntoVenta] @ID = @ID, @ccia = @ccia, @observacion = @observacion, @fecierre = @fecierre", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerDetallesVentaAperturaInterfazResult>> ObtenerDetallesVentaAperturaInterfazAsync(int? idAperturaVentas, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                new SqlParameter
                {
                    ParameterName = "idAperturaVentas",
                    Value = idAperturaVentas ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<ObtenerDetallesVentaAperturaInterfazResult>("EXEC @returnValue = [dbo].[ObtenerDetallesVentaAperturaInterfaz] @idAperturaVentas = @idAperturaVentas", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerItemsBodegasResult>> ObtenerItemsBodegasAsync(int? codbodega, int? state, int? type, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<ObtenerItemsBodegasResult>("EXEC @returnValue = [dbo].[ObtenerItemsBodegas] @codbodega = @codbodega, @state = @state, @type = @type", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerMedicamentosResult>> ObtenerMedicamentosAsync(string codcia, int? type, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<ObtenerMedicamentosResult>("EXEC @returnValue = [dbo].[ObtenerMedicamentos] @codcia = @codcia, @type = @type", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<obtenerVentasPosResult>> obtenerVentasPosAsync(string ccia, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<obtenerVentasPosResult>("EXEC @returnValue = [dbo].[obtenerVentasPos] @ccia = @ccia", sqlParameters, cancellationToken);
