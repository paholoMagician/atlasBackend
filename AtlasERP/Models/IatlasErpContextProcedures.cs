...
namespace AtlasERP.Models
{
    public partial interface IatlasErpContextProcedures
    {
        ...
        Task<List<ObtenerDetallesVentaAperturaInterfazResult>> ObtenerDetallesVentaAperturaInterfazAsync(int? idAperturaVentas, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
